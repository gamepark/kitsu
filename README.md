...
use [our template on GitHub](https://github.com/gamepark/board-kitsu)
...
- `Kitsu` => `Name of your Game`
- `Kitsu` => `NameOfYourGame`
- `kitsu` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [KitsuRules.ts](/rules/src/KitsuRules.ts)
