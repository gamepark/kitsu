...
describe('End of trick - Pick cards', () => {
    describe('2-players tests', () => {
        test.each([
            ...
            {discardedCards: [KitsuCard.Zenko4, KitsuCard.Yako6, KitsuCard.Yako3_1, KitsuCard.Zenko5, KitsuCard.Yako3_2, KitsuCard.Zenko1_2, KitsuCard.Yako1_2, KitsuCard.Zenko2_2]},
            {discardedCards: [KitsuCard.Zenko4, KitsuCard.Yako6, KitsuCard.Yako3_1, KitsuCard.Zenko5, KitsuCard.Yako3_2, KitsuCard.Zenko1_2, KitsuCard.Yako1_2, KitsuCard.Zenko2_2, KitsuCard.Zenko1_1, KitsuCard.Zenko1_3, KitsuCard.Yako4, KitsuCard.Zenko2_1]},
        ])('Given a deck with cards in it, onRuleStart() should return an array of consequences consisting of moves ' +
            'dealing two cards to each player and a rule move starting the PlayKitsuCardRule for the next leader', ({discardedCards}) => {
            // Given
        ...
        test('Given an empty deck, onRuleStart() should return an array of consequences consisting of a single rule ' +
