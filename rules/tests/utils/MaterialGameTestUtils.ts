...
export const create2PlayersGameBuilder = (): MaterialGameBuilder<number, MaterialType, LocationType, RuleId> => {
    ...
    builder.material(MaterialType.PowerToken).createItems(powerToken.map(powerTokenId => ({
        id: powerTokenId,
        location: {
...
export const create2PlayersGameBuilderWithCardsInPlayerHand = (player: 1 | 2, cardIds: KitsuCard[]): MaterialGameBuilder<number, MaterialType, LocationType, RuleId> => {
    ...
    builder.material(MaterialType.KitsuCard).moveItems(kitsuCard => cardIds.includes(kitsuCard.id) ? {
...
export const create2PlayersGameBuilderWithCardsInPlayersHands = (playerHands: {
    player: 1 | 2,
    cardIds: KitsuCard[]
}[]): MaterialGameBuilder<number, MaterialType, LocationType, RuleId> => {
    const builder = create2PlayersGameBuilder();
    playerHands.forEach((hand) => {
        builder.material(MaterialType.KitsuCard).moveItems(kitsuCard => hand.cardIds.includes(kitsuCard.id) ? {
            type: LocationType.PlayerHand,
            player: hand.player
        } : kitsuCard.location);
    });
...
export const create2PlayersGameStateWithCardsInPlayersHands = (playerHands: {
    player: 1 | 2,
    cardIds: KitsuCard[]
...
export const create2PlayersGameBuilderWithCardsInPlayersHandsAndPlayedCards = (playersCards: {
    player: 1 | 2,
...
export const create2PlayersGameStateWithCardsInPlayersHandsAndPlayedCards = (playersCards: {
    player: 1 | 2,
    handCardIds: KitsuCard[],
    playedCardIds: KitsuCard[]
}[]): MaterialGame<number, MaterialType, LocationType> => {
...
export const create2PlayersGameBuilderWithPlayedCards = (playersPlayeddCards: {
    player: 1 | 2,
    playedCardIds: KitsuCard[]
}[]): MaterialGameBuilder<number, MaterialType, LocationType, RuleId> => {
    const builder = create2PlayersGameBuilder();
    playersPlayeddCards.forEach(playerPlayedCards => {
        builder.material(MaterialType.KitsuCard).moveItems(kitsuCard => playerPlayedCards.playedCardIds.includes(kitsuCard.id) ? {
            type: LocationType.PlayedKitsuCardSpot,
...
export const create2PlayersGameStateWithPlayedCards = (playersPlayeddCards: {
    player: 1 | 2,
    playedCardIds: KitsuCard[]
}[]): MaterialGame<number, MaterialType, LocationType> => {
...
export const create2PlayersGameBuilderWithDiscardedCards = (discardedCardIds: KitsuCard[]): MaterialGameBuilder<number, MaterialType, LocationType, RuleId> => {
    let discardIndex = 0;
    const builder = create2PlayersGameBuilder();
    builder.material(MaterialType.KitsuCard).moveItems(kitsuCard => discardedCardIds.includes(kitsuCard.id) ? {
...
export const create2PlayersGameBuilderWithDiscardedCardsAndCardsInPlayersHands = (discardedCardIds: KitsuCard[], playerHands: {
    player: 1 | 2,
    cardIds: KitsuCard[]
}[]): MaterialGameBuilder<number, MaterialType, LocationType, RuleId> => {
    let discardIndex = 0;
...
export const create2PlayersGameStateWithDiscardedCardsAndCardsInPlayersHands = (discardedCardIds: KitsuCard[], playerHands: {
    player: 1 | 2,
    cardIds: KitsuCard[]
}[]): MaterialGame<number, MaterialType, LocationType> => {
