...
describe('HideToOthersWhenRotatedFaceDown strategy tests', () => {
  ...
  ])('given a face down Kitsu card owned by the player, hideToOthersWhenRotatedFaceDown should return an empty array', ({ givenItem, givenPlayer }) => {
    // When
